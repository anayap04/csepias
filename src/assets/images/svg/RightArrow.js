...
const SvgRightArrow = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
    <path d="M140 2.2c-4.4 1.7-7.7 4.4-17.1 13.7-14.4 14.3-16.3 17.7-16.4 28.6 0 5.8.5 9.1 1.9 12 1.3 2.7 33.3 35.5 99.5 101.8l97.6 97.7-97.7 97.8c-76 76-98.2 98.7-99.7 102.2-1.4 3-2.1 6.7-2.1 11 0 10.3 2.9 15.3 16.8 29.1 9.8 9.7 12.7 11.9 17.5 13.7 7.3 2.8 13.1 2.8 20.4.1 5.6-2 10.8-7.1 123-119.3C413.4 261 406 269.2 406 256c0-13.2 7.4-5-122.3-134.6C171.4 9.1 166.3 4.1 160.7 2.1c-7.2-2.6-13.6-2.6-20.7.1z" />
  </svg>
);
