...
const HamMenu = (props) => {
  ...
  return (
    <Menu right styles={styles} customBurgerIcon={<img src={icon} />} customCrossIcon={<img src={cross} />} >
      <MenuItem href="/info">{"Quienes somos"}</MenuItem>
      <MenuItem href="/cursos">{"Cursos"}</MenuItem>
      <MenuItem href="/agenda" >{"Agenda"}</MenuItem>
      <MenuItem href="/editorial" >{"Editorial"}</MenuItem>
    </Menu>
  );
};
